...
for m in 1:M
    δ1m = X_1[1,m]*β₁ .+ X_2[1,m]*β₂ .+ X_3[1,m]*β₃ .- Α*P_star[1,10] .+ ξ[1,m]
    δ2m = X_1[2,m]*β₁ .+ X_2[2,m]*β₂ .+ X_3[2,m]*β₃ .- Α*P_star[2,10]  .+ ξ[2,m]
    δ3m = X_1[3,m]*β₁ .+ X_2[3,m]*β₂ .+ X_3[3,m]*β₃ .- Α*P_star[3,10]  .+ ξ[3,m]
