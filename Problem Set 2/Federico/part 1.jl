using Random, Distributions, CSV, DataFrames, BlackBoxOptim, LinearAlgebra
...
folder = "C:\\Users\\feder\\Dropbox\\Github\\industrial-organization-I\\ps2" # Federico
        # C:\\Users\\joejo\\OneDrive\\Documents\\GitHub\\IO 1\\pset 2 # Joe

## import data
df = CSV.read(string(folder,"\\entryData.csv"), DataFrame, header = false)
Z = zeros(Float64, (F,M))
In = zeros(Int64, (F,M))
